...
ggsave(plot = NeuNIntensity_5x_Mdl1_ppchecks, "Plots/NeuNIntensity_5x_Mdl1_ppchecks.png", 
       width = 12, 
       height = 12, 
       units = "cm")
...
ggsave(plot = NeuNIntensity_5x_Mdl2_ppchecks, "Plots/NeuNIntensity_5x_Mdl2_ppchecks.png", 
       width = 12, 
       height = 12, 
       units = "cm")
```
...
# Save WAIC graph
ggsave(plot = Neurons_Inteinsity_WAIC, "Plots/NeuNIntensity_5x_WAIC.png", 
       width = 12, 
       height = 6, 
       units = "cm")
```
...
tab_model(NeuNIntensity_5x_Fit1, 
          show.se = TRUE,
          digits = 1,
          auto.label = TRUE,
          file="Results/NeuNIntensity_5x_Fit1.doc")
```
...
ggsave(plot = GfapIntensity_5x_Mdl1_ppchecks, "Plots/GfapIntensity_5x_Mdl1_ppchecks.png", 
       width = 12, 
       height = 12, 
       units = "cm")
...
ggsave(plot = GfapIntensity_5x_Mdl2_ppchecks, "Plots/GfapIntensity_5x_Mdl2_ppchecks.png", 
       width = 12, 
       height = 12, 
       units = "cm")
...
ggsave(plot = GfapIntensity_5x_Mdl3_ppchecks, "Plots/GfapIntensity_5x_Mdl3_ppchecks.png", 
       width = 12, 
       height = 12, 
       units = "cm")
```
...
ggsave(plot = Astrocytes_Inteinsity_WAIC, 
       "Plots/GfapIntensity_5x_WAIC.png", 
       width = 12, 
       height = 6, 
       units = "cm")
...
tab_model(GfapIntensity_5x_Fit1, 
          show.se = TRUE,
          auto.label = TRUE,
          digits = 1,
          file="Results/GfapIntensity_5x_Fit1.doc")
```
...
NeuN_Gfap_Correlation_5x_DPI_Fig <-  
  ...
  geom_line(
    ...
    color    = "blue") +
  scale_y_continuous(name = "Astrocytes intensity (GFAP)") +
  scale_x_continuous(name="Neurons intensity (NeuN)") +
  Plot_theme

ggsave(
  plot     = NeuN_Gfap_Correlation_5x_DPI_Fig, 
  filename = "Plots/NeuN_Gfap_Correlation_5x_DPI_Fig.png", 
  width    = 12, 
  height   = 12, 
  units    = "cm")
...
ggsave(plot = Iba1Intensity_5x_Mdl1_ppchecks, "Plots/Iba1Intensity_5x_Mdl1_ppchecks.png", 
       width = 12, 
       height = 12, 
       units = "cm")
...
ggsave(plot = Iba1Intensity_5x_Mdl2_ppchecks, "Plots/Iba1Intensity_5x_Mdl2_ppchecks.png", 
       width = 12, 
       height = 12, 
       units = "cm")
...
ggsave(plot = Iba1Intensity_5x_Mdl3_ppchecks, "Plots/Iba1Intensity_5x_Mdl3_ppchecks.png", 
       width = 12, 
       height = 12, 
       units = "cm")
```
...
ggsave(plot = Microglia_Inteinsity_WAIC, 
       "Plots/Iba1Inteinsity_5x_WAIC.png", 
       width = 12, 
       height = 6, 
       units = "cm")
```
...
tab_model(Iba1Intensity_5x_Fit1, 
          show.se = TRUE,
          auto.label = TRUE,
          digits = 1,
          file="Results/Iba1Intensity_5x_Fit1.doc")
```
...
NeuN_Iba1_Correlation_5x_DPI_Fig <-  
  ...
  geom_line(
    ...
    position = position_dodge(0.05), 
    color    = "blue") +
  scale_y_continuous(name = "Microglia intensity (IBA1)") +
  scale_x_continuous(name="Neurons intensity (NeuN)") +
  Plot_theme

ggsave(
  plot     = NeuN_Iba1_Correlation_5x_DPI_Fig, 
  filename = "Plots/NeuN_Iba1_Correlation_5x_DPI_Fig.png", 
  width    = 12, 
  height   = 12, 
  units    = "cm")
...
ggsave(plot = NeuNIntensity_5x_Patch, 
       "Plots/NeuNIntensity_5x_Patch.png", 
       width = 15, 
       height = 12, 
       units = "cm")
```
...
ggsave(plot = GfapIntensity_5x_Patch, 
       "Plots/GfapIntensity_5x_Patch.png", 
       width = 15, 
       height = 12, 
       units = "cm")
```
...
ggsave(plot = Iba1Intensity_5x_Patch, 
       "Plots/Iba1Intensity_5x_Patch.png", 
       width = 15, 
       height = 12, 
       units = "cm")
```
...
describe_posterior(Astrocytes_Neurons_Tess_Fit1)
```

We create a .doc files with the main output:

```{r}
#| label: 5x_Iba1_Neurons_SaveSummary
#| include: true
#| warning: false
#| message: false
#| results: false

tab_model(Astrocytes_Neurons_Tess_Fit1, 
          show.se = TRUE,
          auto.label = TRUE,
          digits = 1,
          file="Results/Astrocytes_Neurons_Tess_Fit1.doc")
```
...
describe_posterior(Microglia_Neurons_Tess_Fit1)
```
...
ggsave(
  ...
  file = "Plots/Astrocytes_Neurons_Tess_Patch.png", 
  width = 12, 
  height = 12, 
  units = "cm")
```
...
ggsave(
  ...
  file = "Plots/Microglia_Neurons_Tess_Patch.png", 
  width = 12, 
  height = 12, 
  units = "cm")
```
...
Contrary to astrocytes, results for microglia show and increasing slope for fixed effects and increasing slopes for ramdom effects.
...
The reeults show that the negavite correlation between both cell types becomes less negative as the DPI increments. This is consistent with a two population of cells which intermingle progressively.

## 6.4 Modeling of astrocytes-microglia covariance using tessellations

We use the same Bayesian modeling implemented in [5.3 Bayesian modeling of glial-neurons covariance] for analyzing the number of astrocytes in tesselated microglial regions.
...
ggsave(plot = Astrocytes_Microglia_Mdl1_ppchecks, 
       file = "Plots/Astrocytes_Microglia_Mdl3_ppchecks.png", 
       width = 10, 
       height = 10, 
       units = "cm")
...
describe_posterior(Astrocytes_Microglia_Tess_Fit1)
```

We create a .doc files with the main output:

```{r}
#| label: 5x_Astrocytes_Microglia_SaveSummary
#| include: true
#| warning: false
#| message: false
#| results: false

tab_model(Astrocytes_Microglia_Tess_Fit1, 
          show.se = TRUE,
          auto.label = TRUE,
          digits = 1,
          file="Results/Astrocytes_Microglia_Tess_Fit1.doc")
```
...
ggsave(plot = Astrocytes_Microglia_Contrast_Fig1,
       file = "Plots/Astrocytes_Microglia_Tess_Patch.png", 
       width = 12, 
       height = 12, 
       units = "cm")
...
The resuls are shown in Figure 3D of the main research article.
...
write.csv(Astrocytes_Centroid, "DataTables/5x_Astrocytes_Centroid-SD.csv") 
```
...
write.csv(Astrocytes_Centroid, "DataTables/5x_Microglia_Centroid-SD.csv") 
```
...
write.csv(Scar_Centroid_Wide, "DataTables/5x_Astrocytes_Miroglia_Distance.csv")
```
...
Scar_Distance_Mdl1_ppchecks <- brms::pp_check(Scar_Distance_Fit1, ndraws = 50) +
  ...
  scale_x_continuous(name="\n Astrocytes - Microglia distance (mm)",
                     limits=c(-1, 3), 
                     breaks=seq(-1, 3,1)) +
...
ggsave(plot = Scar_Distance_Mdl1_ppchecks, 
       file = "Plots/Scar_Distance_Mdl11_ppchecks.png", 
       width = 10, 
       height = 10, 
       units = "cm")
...
describe_posterior(Scar_Distance_Fit1)
```
...
Scar_sd_Mdl1_ppchecks <- brms::pp_check(Scar_sd_Fit1, ndraws = 50) +
  ...
  labs(title = "Model 1",
       subtitle = "Microglial dispersion and DPI as predictors",
       caption = "Model: sdA ~  sdM * DPI") +
  
  scale_x_continuous(name="\n Astrocyte dispersion (sd) ",
                     limits=c(0, 6), 
                     breaks=seq(0,6,2)) +
...
ggsave(plot = Scar_sd_Mdl1_ppchecks, "Plots/Scar_sd_Mdl1_ppchecks.png", 
       width = 12, 
       height = 12, 
       units = "cm")
...
Scar_sd_Mdl2_ppchecks <- brms::pp_check(Scar_sd_Fit2, ndraws = 50) +
  ...
  labs(title = "Model 2",
       subtitle = "Microglial dispersion and DPI as predictors with heteroskedasticity",
       caption = "Model: sdA ~  sdM * DPI \n sigma ~  sdM * DPI") +
...
ggsave(plot = Scar_sd_Mdl2_ppchecks, "Plots/Scar_sd_Mdl2_ppchecks.png", 
       width = 12, 
       height = 12, 
       units = "cm")
...
Scar_sd_Mdl3_ppchecks <- brms::pp_check(Scar_sd_Fit3, ndraws = 50) +
  ...
  labs(title = "Model 3",
       subtitle = "Microglial dispersion and DPI as predictors with splines",
...
ggsave(plot = Scar_sd_Mdl3_ppchecks, "Plots/Scar_sd_Mdl3_ppchecks.png", 
       width = 12, 
       height = 12, 
       units = "cm")
```
...
ScarSD_WAIC <- w[, 7:8] %>% 
  ...
  coord_flip() +
  labs(x = NULL, y = NULL,
       title = "Asttrocyte dispesion (WAIC)") +
  theme_classic() +
  theme(
      plot.title = element_text(size=16, hjust = 0.5, face="bold"),
      plot.subtitle = element_text(size = 12, color = "black"),
...
describe_posterior(Scar_sd_Fit1)
```
...
ScarSD_Effects_Fig  <- 
  ...
  scale_y_continuous(name = "Astrocyte dispersion (sd)  \n") +
  scale_x_continuous(name=" \n Microglia dispersion (sd)") +
...
The results is shown in Figure 3G of the main research article.
